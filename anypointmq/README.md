...
This document defines how to describe Anypoint MQ-specific information with AsyncAPI. 
...
---|:---|:---
<a name="serverObjectProtocolFieldValueAnypointMQ"></a>`server.protocol` | `anypointmq` | Anypoint MQ protocol based on the [Anypoint MQ Broker REST API](https://docs.mulesoft.com/mq/mq-apis#mqbrokerapi).
